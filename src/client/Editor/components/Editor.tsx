  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      <Box display="flex" flexDirection="column" gap={2}>
        ...
        <Button variant="outlined" color="secondary" onClick={() => appendSection({ id: Date.now(), title: '', widgets: [] })}>Add Section</Button>
        ...
        {sectionFields.map((section, sectionIndex) => (
          <Box key={section.id} mt={2} p={2} border="1px solid #ccc">
            ...
            />
            <Button variant="outlined" color="secondary" onClick={() => addWidget(sectionIndex, 'countdown')}>Add Countdown</Button>
            <Button variant="outlined" color="secondary" onClick={() => addWidget(sectionIndex, 'contactForm')}>Add Contact Form</Button>
